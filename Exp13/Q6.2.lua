	...
	--Segundo imã (centro em 0,6)
    mi_addnode(-2.5,4.5)	    
    mi_addnode(2.5,4.5)
    mi_addnode(2.5,9.5)
    mi_addnode(-2.5,9.5)
    mi_addsegment(-2.5,9.5,2.5,9.5)
    mi_addsegment(2.5,9.5,2.5,4.5)
    mi_addsegment(2.5,4.5,-2.5,4.5)
    mi_addsegment(-2.5,4.5,-2.5,9.5)
    --define este imã como Grupo 7
    mi_selectnode(-2.5,4.5)	      
    mi_selectnode(2.5,4.5)
    mi_selectnode(2.5,9.5)
    mi_selectnode(-2.5,9.5)    
    mi_setnodeprop("Neodimio N37", 7) 
    mi_clearselected()
    mi_selectsegment(-2.5,9.5,2.5,9.5)
    mi_selectsegment(2.5,9.5,2.5,4.5)
    mi_selectsegment(2.5,4.5,-2.5,4.5)
    mi_selectsegment(-2.5,4.5,-2.5,9.5)
    ...
    file = openfile("Q6.2.txt", "w")
    write(file, format("Dist(mm)\tF_y\n"))
